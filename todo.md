...
- [ ] Gap 3: Interval charts capped at most recent 30 days even when more imported — full-history range selector (30/90/365/all), peak-demand analysis over entire span
- [ ] Gap 4: Peak demand/peak use charges not recognizable in UI — first-class demand-charge visibility: labeled charge lines, peak events view, demand share of bill, TOU window display
- [ ] Gap 5: Site not fully navigable — audit all routes/links, fix dead-ends, every page reachable and escapable
- [ ] Gap 6: Paid-plan "coming soon" features inaccessible — make them functional or honestly remove/gate them
...
- [ ] Gap 9: Entity→sites→meters model — organizational layer (household/owner/company) owning many sites, each with many meters; portfolio rollups; entity-level dashboards
